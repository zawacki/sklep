...
use Shop\MovieBundle\Form\MovieType;
...
class MovieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ShopMovieBundle:Movie')->findAll();
     ...
     * @Method("POST")
     * @Template("ShopMovieBundle:Movie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ShopMovieBundle:Movie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ShopMovieBundle:Movie:edit.html.twig")
     */
